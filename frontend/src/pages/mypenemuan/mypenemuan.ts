...
@Component({
  selector: 'page-mypenemuan',
  templateUrl: 'mypenemuan.html',
})
export class MypenemuanPage {
  posts: Array<{}>;
  response: any;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public http: Http,
  	...
  	this.DataStorage.getData().then((value) => {
  		console.log(value);
	  	this.http.post(linkgetposts, JSON.stringify({usernim: value.nim, jenis: "penemuan"})).subscribe(data => {
	  		console.log(value)
	  		//console.log(data);
